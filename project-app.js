...
function loadProject() {
    ...
    const startDate = dayjs(currentProject.startDate);
    const endDate = dayjs(currentProject.endDate);
    const today = dayjs();
    ...
    // Update team size
    document.getElementById('teamSize').textContent = currentProject.teamSize;
...
function loadMilestones() {
    ...
    // No animations needed - let Bootstrap handle everything
}
...
function createMessageElement(message) {
    const div = document.createElement('div');
    div.className = message.isAdmin ? 'message admin-reply' : 'message';
...
function sendMessage() {
    ...
    currentProject.messages.push(newMessage);
